...
RUN curl -sL https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.18.19/openshift-client-linux-ppc64le-rhel8-4.18.19.tar.gz | tar -C /usr/local/bin -xzf - && \
